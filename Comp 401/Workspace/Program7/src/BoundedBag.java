...
public class BoundedBag {
	...
	private final int NOT_FOUND = -999;
	...
	public class BoundedBagIterator implements Iterator<Integer> {

		// Data members.
		private BoundedBag bag;
		private int index; 


		public BoundedBagIterator(BoundedBag theBag) {
			bag = theBag;
			index = 0;
		}
	...
	}  // end of BoundedBagIterator

	
	// The remaining methods of BoundedBag follow.  This includes the method
	// "iterator" which does not need to be modified.
	...
	public boolean add( int theValue) {
		if (topPosition < contents.length-1){
	...
	public String toString() {
	   ...
	   /**
		 ...
		 */
		public BoundedBagIterator iterator() {
			return new BoundedBagIterator(this);
		}
