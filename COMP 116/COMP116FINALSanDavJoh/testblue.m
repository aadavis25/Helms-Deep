...
while 1
    ...
    if ((y >= 225) && (y <= 469)) && ((x >= 337) && (x <= 597));
        result = [result; g cell2mat(a) 't']; %Response registered as true if they select the suggested color (blue)
    else 
        result = [result; g cell2mat(a) 'f']; %Response registered as false otherwise
    end         
end
count = count+1;
save('testbluevar.mat')
