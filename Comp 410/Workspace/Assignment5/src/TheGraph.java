...
public class TheGraph {
	...
	int num = 0;
	 ...
	 //getters 
	 public  HashMap getListNames() {return listNames;}
	 public ArrayList<GVertex> getListVert() {return listVert;}
	...
	/**
	 * @return size of the graph in number of vertices (mostly for testing)
	 */
	public int size(){
